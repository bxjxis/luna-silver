    ...
    <div className="bg-black text-white overflow-x-hidden">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 select-none">
          ...
          <p className="font-montserrat text-stone-500 text-sm tracking-[0.15em] normal-case mb-14 max-w-lg mx-auto leading-loose">
            ...
            <br />
            <span className="text-stone-600 tracking-[0.12em]">
              — Matthew 4:4
            </span>
          </p>
      ...
      <section className="relative bg-stone-950 min-h-screen flex flex-col justify-start px-6 md:px-16 pt-32 pb-24">
        <ScrollReveal>
          {/* Label — far left */}
          <h2
            className="font-montserrat text-stone-300 tracking-[0.3em] uppercase mb-40"
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="font-montserrat text-stone-500 text-sm tracking-[0.15em] normal-case leading-loose mb-16">
              In faith, &ldquo;food&rdquo; has never referred only to the needs
              of
              <br />
      ...
      >
        <ScrollReveal>
          <h2
            className="font-montserrat text-stone-300 tracking-[0.3em] uppercase mb-16"
            style={{ fontSize: "clamp(1rem, 2vw, 1.25rem)", fontWeight: 400 }}
          >
            Customize Your Soulfood
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div>
              <p className="font-montserrat text-stone-500 text-sm tracking-[0.15em] leading-loose mb-12">
                Every piece of Soulfood jewellery begins with you. Whether you
                want to put your own touch on an existing design or build
                something entirely new, we make it possible.
              </p>
              ...
              <div className="space-y-10">
                <div>
                  ...
                  <p className="font-montserrat text-stone-500 text-sm tracking-[0.1em] leading-loose">
                    Choose your chain, pendant, stone, and finish from our
                    curated parts. Mix and match to assemble a piece that is
                    uniquely yours — no design experience needed.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-montserrat text-stone-500 text-sm tracking-[0.1em] leading-loose">
                    Bring us a sketch, a feeling, or just an idea. We work with
                    you from concept to finished piece — entirely handmade in
                    sterling silver, built around your story.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 flex-1">
              <div>
                <h4 className="font-montserrat text-stone-300 text-xs tracking-[0.3em] uppercase border-b border-stone-800 pb-3 mb-5">
                  Customer Care
                </h4>
                <ul className="space-y-3 font-montserrat text-sm text-stone-600">
                  {["Care Card", "Size Guide", "Shipping", "FAQ"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
